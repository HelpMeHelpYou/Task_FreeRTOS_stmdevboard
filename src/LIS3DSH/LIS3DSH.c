...
void LIS3DSH_Init(void) {
	...
	LIS3DSH_Set_Output (LIS3DSH_Output_Z_Enable| LIS3DSH_Output_Y_Enable | LIS3DSH_Output_X_Enable  |  LIS3DSH_Output_Rate_50Hz);
	LIS3DSH_Set_Output_Feature (LIS3DSH_Output_Feature_Range_2g | LIS3DSH_Output_Feature_Self_Test_Disable);
